...
public class CalendarUtil {	
   ...
   public static Credential authorize() throws IOException {
      ...
      // InputStream in =  new FileInputStream(new File("D://google_authen//client_secret.json.json"));
   	...
   	InputStream in = CalendarUtil.class.getClassLoader().getResourceAsStream("client_secret.json");
   	if (in == null) {
			// Web Path
			in = Thread.currentThread().getContextClassLoader().getResourceAsStream("client_secret.json");
		}
