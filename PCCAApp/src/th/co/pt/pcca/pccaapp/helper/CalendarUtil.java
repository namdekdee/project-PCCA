...
import th.co.pt.pcca.pccaapp.entities.util.CalendarObj;
...
public class CalendarUtil {	
   ...
   private static final String APPLICATION_NAME =
       "Google Calendar API Java Quickstart2";
   ...
   private static final List<String> SCOPES =
       Arrays.asList(CalendarScopes.CALENDAR_READONLY); 					//edit here
   ...
   public static Credential authorize() throws IOException {
      ...
      // InputStream in =  new FileInputStream(new File("D://google_authen//client_secret.json.json"));
   	...
   	InputStream in = CalendarUtil.class.getClassLoader().getResourceAsStream("client_secret2.json");
   	if (in == null) {
			// Web Path
   ...
   public static boolean AddEvent(CalendarObj obj){
	   try
	   {
	// Build a new authorized API client service.
       ...
       */
       ...
       Event event = new Event()
		...
		.setSummary(obj.getSubject())
	    .setLocation(obj.getLocation())
	    .setDescription(obj.getBody());

	    //.setDescription("A chance to hear more about Google's developer products.");
		
		//System.out.println("event: "+event.getDescription());

		DateTime startDateTime = new DateTime(obj.getStart_date());
		...
		DateTime endDateTime = new DateTime(obj.getEnd_date());
		...
		EventAttendee[] attendees = new EventAttendee[] {
				 new EventAttendee().setEmail(obj.getEmail()),
			     new EventAttendee().setEmail(obj.getEmail_invite())
