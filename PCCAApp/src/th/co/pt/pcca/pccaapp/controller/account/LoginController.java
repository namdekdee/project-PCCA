...
public class LoginController {
	...
	public ModelAndView login( HttpServletRequest httpRequest ) {
		try
		{
		String uri = WebUtil.WebServiceUrl() + "HrisService/account-getmenu";
	...
	public @ResponseBody List<StepWorkFlowTransactionObj> testGetApprove() {
		...
		String uri = WebUtil.WebServiceUrl() + "HrisService/workflow-getapproverstep";
		...
		data.seq_no = "0004";		
		RestTemplate restTemplate = new RestTemplate();
		List<StepWorkFlowTransactionObj> member_data = restTemplate.postForObject(uri, data,
				List.class);
		return member_data;
	}
