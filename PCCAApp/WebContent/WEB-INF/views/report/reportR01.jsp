...
// 				url : 'util-getmemberfollower-company',
				url : 'report-getmemberfollower-company',
				type : "Post",
				contentType : "application/json",
				data: JSON.stringify(data),
				dataType : 'json',
...
// 			var guId = '${sessionScope.C_UserInfo.gu_id}';
			...
			if(testDate){
		    	...
		    	var link = ctx+"/report-getDataR01-PDF?comp1="+company1.value+"&comp4="+company4.value
...
// 	                   	Clear();
			...
			if(testDate){
				var ctx = "${pageContext.request.contextPath}";		    	
		    	var link = ctx+"/report-getDataR01-Excel?comp1="+company1.value+"&comp4="+company4.value
	    			+"&comp5="+company5.value+"&comp6="+company6.value+"&comp7="+company7.value+"&emp_id="+emp_id.value
	    			+"&startDate="+start_date_db+"&endDate="+end_date_db;
	...
	<div class="row">
		...
		<div class="col-md-4">
			<select id="ddlBranch" class="form-control select2"
				style="width: 100%;" onchange="SetDropDownEmp();"></select>
		</div>
		<div class="col-md-1">
